...
class CalculadoraPinones:
    ...
    def crear_variables(self):
        ...
        self.vars = {
            ...
            'calculo_engranaje': {  # Cambiado de 'engranaje_calculo' a 'calculo_engranaje'
    ...
    def crear_seccion(self, titulo, campos, funcion_calculo, fila, columna):
        ...
        tk.Label(frame, text="Resultado:", bg='#e0e0e0').grid(row=len(campos)+2, column=0, padx=5, sticky='e')
    ...
    def calcular_diametro_pinon(self, entries):
        ...
        try:
            ...
            self.vars['diametro_pinon']['resultado'].set(f"{diametro:.2f}")
        except ValueError:
            messagebox.showerror("Error", "Por favor ingrese valores numéricos válidos")
    ...
    def calcular_diametro_ext(self, entries):
        ...
        try:
            ...
            self.vars['diametro_ext']['resultado'].set(f"{diametro:.2f}")
        except ValueError:
            messagebox.showerror("Error", "Por favor ingrese valores numéricos válidos")
